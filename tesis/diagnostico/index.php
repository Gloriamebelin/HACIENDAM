...
<body>  
  ...
  <div class="navegacion">
    <ul>
      ...
      <li class="lista activo" data-color="#05c46b">
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m7">
      <div class="carousel-container " style=" margin-left:10px;margin-right: 10px; width: 95%;">
        <div class="carousel">
          <div class="slide"><img src="suelo.jpg"><div class="caption">Control cultural:Es fundamental la preparación del suelo, la cual servirá como un medio para a destruir a los huevos, larvas entre sus otras fases del gusano cogollero permitiendo dejar que el cultivo se encuentre expuesto al sol. </div></div>
          <div class="slide"><img src="hongo.jpg"><div class="caption">Control biológico:El desarrollo del control biológico se trata de una práctica agrícola que busca la destrucción total o parcial tanto de las enfermedades 
          como de las plagas utilizando los enemigos naturales, uno de esos enemigos que se podría utilizar para eliminar el gusano cogollero sería los hongos entomopatógenos.</div></div>
          <div class="slide"><img src="spínosad.jpg"><div class="caption">Control químico: El control con productos químicos que permita evitar el desarrollo de la larva en su tercera instancia aplicando los productos de spinosad y metoxifenocida así logrando alcanzar el 100 y el 84.4% del control de la plaga.</div></div>
          <div class="slide"><img src="Bacillus.jpg"><div class="caption">Control microbiológico:Para el control de larvas se realizan aspersiones foliares de la bacteria Bacillus thu-ringiensis en dosis de 2,5 g/litro cada 8 días.</div></div>
        </div>
    ...
    <div class="w3-col m2">
      ...
      <div class="w3-card w3-round w3-white w3-center">
        <div class="w3-container">
          ...
          <form  action="http://localhost/tesis/" method="post">
            <input type="submit" class="w3-hover-red" name="btncerrar" style="background-color:#229954;color: white;cursor: pointer;width: 100%;padding: 10px;" value="Cerrar sesión">
          </form>
        </div><br>
      </div>
      <br>
      ...
      <div class="w3-card w3-round w3-white w3-center">
        <div class="w3-container"><br>
          <img src="control.jpg" width="220px"><br><br>
          <p><button class="w3-button w3-block w3-hover-green " style="background-color:black;color:white;"> <a href='https://www.intagri.com/articulos/fitosanidad/manejo-integrado-de-gusano-cogollero-en-maiz-y-sorgo#:~:text=Existen%20diversos%20microorganismos%20ben%C3%A9ficos%20para,efectividad%20si%20se%20usa%20correctamente.'target="_blank"> Info </a></button></p><br>
        </div>
      </div>
      <br>
      ...
      <div class="w3-card w3-round w3-white w3-center">
        <div class="w3-card w3-round w3-white w3-center">
        <div class="w3-container">
          <img src="maiz.jpg" width="220px"><br><br>
          <p><button class="w3-button w3-block w3-hover-green " style="background-color:black;color:white;"> <a href='https://agriculture.basf.com/mx/es/proteccion-de-cultivos-y-semillas/productos/expander.html#:~:text=Expander%C2%AE%2C%20insecticida%20de%20alta,tu%20cultivo%20contra%20gusano%20cogollero.'target="_blank">Info </a></button></p><br>
        </div>
      </div>
      </div>
      <br>
